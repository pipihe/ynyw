    ...
    $.widget("sweet.widgetWindow", $.sweet.widget, /** @lends Sweet.Window.prototype*/{
        ...
        _render: function () {
            ...
            if ($.isNull(options.buttons)) {
                ...
                okButtonEl.css(buttonCss).html(Sweet.core.i18n.dialog.ok).appendTo(bottomEl);
                cancelButtonEl.css(buttonCss).html(Sweet.core.i18n.dialog.cancel).appendTo(bottomEl);
