 ...
 */
var mapInfo = {};
Supermapflex = function(mapObj, id, name, width, height, data, layerLengedInfo){
    var me = this;
    me.id = id;
    me.name = name;
    me.width = width;
    ...
    me.init(id, name, width, height, data, me.layerLengedInfo);
};
//动态创建Flex
Supermapflex.prototype.createFlashMove = function(id, sName, src, width, height,data,layerLengedInfo){
...
Supermapflex.prototype.init = function(id,name,width,height,data,layerLengedInfo){
    var me = this;
    me.createFlashMove(id, name, SWEET_JS_BASE_PATH + "lib/supermap/flash/customMap_flex.swf", width, height, data,layerLengedInfo);    
    me.getDituSWF(name);
