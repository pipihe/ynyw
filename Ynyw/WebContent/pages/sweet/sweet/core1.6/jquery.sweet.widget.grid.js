...
(function($, undefined) {
    ...
    $.widget("sweet.widgetGrid", $.sweet.widget, /** @lends Sweet.grid.Grid.prototype*/{
        ...
        __createSelectColumnWinEl: function(winEl, columnData, okBtn, cancelBtn) {
            ...
            $("<span>").html(Sweet.core.i18n.combobox.checkAll).appendTo(rowItemAllEl);
            //记录全选EL和各列的EL
            ...
            for (var i = 0; i < rows; i++) {
                ...
                for (var j = 0; j < column; j++) {
                    ...
                    $("<span>").html(itemData["text"]).appendTo(rowItemEl);
        ...
        _createGridHeader: function() {
            ...
            if (sn) {
                ...
                headerTdEl = $("<td>").attr("rowspan", rows.length)
                        ...
                        .mouseleave({"me": me}, me.__onHeaderTdMouseLeave)
                        .appendTo(headerTrEl);
                headerTdDivEl = $("<div>").html(i18n.SN).addClass(gridHeaderTextClass).appendTo(headerTdEl);
                ...
                if (0 === e.button && aEl.hasClass(gridContentMenuClass)) {
                    ...
                    if (showMenu) {
                        ...
                        if (x + mw > me.gridEl.width() - scrollWidth - 2) {
                            x = me.gridEl.width() - scrollWidth - 2 - mw;
                        }
						var mcfg = {
        ...
        _onPageListClick: function(e, self) {
            ...
            if (gridPagingComboboxType[0] === obj.type) {
                ...
                emEl.html(obj.text.replace("{0}", value));
        ...
        _createDropDown: function(data) {
            ...
            for (var i = 0, temp, tempIndex; i < data.length; i++) {
                ...
                $("<li>").val(-1 === tempIndex ? temp : temp.substr(0, tempIndex)).html(temp).appendTo(ulEl);
            }
        ...
        _createPagingBarTotalText: function() {
            ...
            totalTextEl.addClass(totalTextElClass)
                    .html(i18n.text.replace("{0}", options.data.page.total)).appendTo(me.pagingInnerEl);
        },
        /**
        ...
        _refreshPagingBarTotalText: function(total) {
            var me = this;
            me.totalTextEl.html(i18n.text.replace("{0}", total));
        },
        /**
         * @description 创建分页栏按钮
         * @private
        ...
        _createPagingBarNumItem: function() {
            var me = this,
                    ...
                    numPrevMoreEl = $("<span>").html("...").hide(),
                    numNextMoreEl = $("<span>").html("..."),
            ...
            if (totalPage <= minNumBtn) {
                ...
                for (var i = 0; i < minNumBtn; i++) {
                    ...
                    if (0 === i) {
                        ...
                        numEl.val(totalPage).html(totalPage);
