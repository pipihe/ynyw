...
(function($, undefined) {
    ...
    $.widget("sweet.widgetFormLabelImage", $.sweet.widgetForm, /** @lends Sweet.form.LabelImage.prototype*/{
        ...
        options: /** @lends Sweet.form.LabelImage.prototype*/{
            ...
            /**
             * @description 图片类型,目前共有35种："delete","save","plus","minus","setting","import","export",
             ...
             * "dashboard","dashboard_setting","edit","enter_fullscreen","exit_fullscreen","lock","unlock","add","reset"
             * @type {String}
             * @default null
             */
            imageType: null,
