    ...
    $.widget("sweet.widgetBxCarousel", $.sweet.widget, /** @lends Sweet.BxCarousel.prototype*/{
        ...
        _creatUL :function(data0) {
            ...
            $.each(data, function(index, obj){
                ...
                // 添加点击事件
                liChildEl.bind("click", {"me": me, "obj": paramObj, "image": obj.image, "key": obj.value}, 
                        me._clickImage);
                // 保存数据
        ...
        _clickImage: function(event) {
            var me = event.data.me,
                    ...
                    key = event.data.key;
            me._setActiveItemCSS(image, obj, me);   //改变被选中选项的样式
         ...
         */
        _setActiveItemCSS : function(image, obj, bxCarObj){
